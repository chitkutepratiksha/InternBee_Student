            ...
            <div className="flex-1 p-8 ml-96 bg-amber-300">
                ...
                <div className="bg-slate-50 p-6 flex items-center justify-between border shadow-xl">
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        <h1 className="text-4xl font-bold">Intern-Bee</h1>
                    </div>
                    ...
                    <div className="flex items-center space-x-6">
                        ...
                        <a href="#" className="text-2xl font-bold focus:text-yellow-300 focus:border-yellow-300 focus:border-b-4">Services</a>
                        <a href="#" className="text-2xl font-bold focus:text-yellow-300 focus:border-yellow-300 focus:border-b-4">Location</a>
                    </div>
